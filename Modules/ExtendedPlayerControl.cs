...
namespace TownOfHost
{
    static class ExtendedPlayerControl
    {
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target)
        {
            ...
            if (target.Is(CustomRoles.Wisp) && Main.IsWisping) return true;
        ...
        public static void CustomSyncSettings(this PlayerControl player)
        {
            ...
            switch (player.GetCustomRole())
            {
                ...
                case CustomRoles.Shapeshifter:
                    shapeshifterOptions.ShapeshifterCooldown = Options.ShiftCooldown.GetFloat();
                    shapeshifterOptions.ShapeshifterDuration = Options.ShiftDuration.GetFloat();
                    break;
                ...
                case CustomRoles.Eradicator:
                    options.KillCooldown = Options.DefaultKillCooldown + Options.AcidCreateDuration.GetFloat();
                    break;
                case CustomRoles.Wisp:
                    options.CrewLightMod = Options.WispVision.GetFloat();
                    goto OneSecVent;
                //          break;
                ...
                InfinityVent:
                    ...
                    break;
                OneSecVent:
                    engineerOptions.EngineerCooldown = 1;
                    engineerOptions.EngineerInVentMaxTime = 0;
                    break;
            }
            ...
            switch (player.GetCustomSubRole())
            {
                ...
                case CustomRoles.Watcher:
                    ...
                    break;
                case CustomRoles.Blind:
                    options.CrewLightMod = 0.1f;
                    options.ImpostorLightMod = 0.1f;
                    break;
            ...
            switch (player.GetCustomSubRole())
            {
                case CustomRoles.Overclocked:
                    options.KillCooldown = Options.OverclockedKillCD.GetFloat();
                    break;
            }
            ...
            switch (player.GetCustomRole())
            {
                ...
                case CustomRoles.Crusader:
                    ...
                    break;
                case CustomRoles.Deputy:
                    options.KillCooldown = Sheriff.KillCooldown.GetFloat();
                    break;
                case CustomRoles.Cultist:
                case CustomRoles.Consigliere:
                    //   options.KillCooldown = Consigliere.ConsigKillCooldown.GetFloat();
                    break;
            }
        ...
        public static string GetRoleInfo(this PlayerControl player, bool InfoLong = false)
        {
            ...
            if (role is CustomRoles.Crewmate or CustomRoles.Impostor or CustomRoles.Engineer or CustomRoles.Scientist or CustomRoles.Shapeshifter)
                InfoLong = false;
        ...
        public static bool CanUseKillButton(this PlayerControl pc)
        {
            ...
            return pc.GetCustomRole() switch
            {
                ...
                CustomRoles.Deputy => Sheriff.CanUseKillButton(pc),
                CustomRoles.Investigator => Investigator.CanUseKillButton(pc),
                CustomRoles.Consigliere => Consigliere.CanUseKillButton(pc),
                CustomRoles.Arsonist => false,
                CustomRoles.PlagueBearer => true,
                CustomRoles.Pestilence => true,
                CustomRoles.Glitch => true,
                CustomRoles.Cultist => true,
                CustomRoles.Juggernaut => true,
                CustomRoles.Predator => true,
                CustomRoles.Traitor => true,
                CustomRoles.NeutSerialKiller => true,
                CustomRoles.Vindicator => true,
                CustomRoles.PoisonMaster => true,
        ...
        public static bool SameTeamAsTarget(this PlayerControl killer, PlayerControl target)
        {
            ...
            if (killer.Is(CustomRoles.NeutSerialKiller) && target.Is(CustomRoles.SKSchrodingerCat)) return true;
            if (killer.Is(CustomRoles.Vindicator) && target.Is(CustomRoles.VSchrodingerCat)) return true;
        ...
        public static void ResetKillCooldown(this PlayerControl player, bool meeting = false)
        {
            ...
            {
                case CustomRoles.Overclocked:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.OverclockedKillCD.GetFloat();
                    break;
            }
            switch (player.GetCustomRole())
            {
                ...
                case CustomRoles.Escort:
                    ...
                    break;
                case CustomRoles.Eradicator:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.DefaultKillCooldown + Options.AcidCreateDuration.GetFloat();
                    break;
                case CustomRoles.Predator:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.PredatorKillCD.GetFloat();
                    break;
                case CustomRoles.Crusader:
                ...
                case CustomRoles.Arsonist:
                    ...
                    break;
                case CustomRoles.NeutSerialKiller:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.SerialKillerKillCD.GetFloat();
                    break;
                case CustomRoles.Traitor:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.TraitorKillCD.GetFloat();
                    break;
                case CustomRoles.Vindicator:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.VindicatorKillCD.GetFloat();
                    break;
                case CustomRoles.Parasite:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.ParasiteKillCD.GetFloat();
                    break;
                case CustomRoles.Werewolf:
                ...
                case CustomRoles.Jackal:
                    ...
                    break;
                case CustomRoles.Mimicker:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.MimickerKillCD.GetFloat();
                    break;
                case CustomRoles.Wraith:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.WraithKillCD.GetFloat();
                    break;
                case CustomRoles.Glitch:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.GlitchKillCD.GetFloat();
                    break;
                case CustomRoles.CorruptedSheriff:
                case CustomRoles.Sheriff:
                case CustomRoles.Deputy:
                ...
                case CustomRoles.Investigator:
                    ...
                    break;
                case CustomRoles.Consigliere:
                    Consigliere.SetKillCooldown(player.PlayerId); //シェリフはシェリフのキルクールに。
                    break;
                case CustomRoles.Pestilence:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.PestilKillCooldown.GetFloat();
                    break;
                case CustomRoles.Cultist:
                    Main.AllPlayerKillCooldown[player.PlayerId] = Options.ConvertCooldown.GetFloat();
                    break;
                case CustomRoles.BloodKnight:
        ...
        public static float GetKillCooldown(this PlayerControl player)
        {
            ...
            {
                case CustomRoles.Overclocked:
                    KillCooldown = Options.OverclockedKillCD.GetFloat();
                    break;
            }
            switch (player.GetCustomRole())
            {
                ...
                case CustomRoles.Escort:
                    ...
                    break;
                case CustomRoles.Predator:
                    KillCooldown = Options.PredatorKillCD.GetFloat();
                    break;
                case CustomRoles.NeutSerialKiller:
                    KillCooldown = Options.SerialKillerKillCD.GetFloat();
                    break;
                case CustomRoles.Traitor:
                    KillCooldown = Options.TraitorKillCD.GetFloat();
                    break;
                case CustomRoles.Vindicator:
                    KillCooldown = Options.VindicatorKillCD.GetFloat();
                    break;
                case CustomRoles.Parasite:
                    KillCooldown = Options.ParasiteKillCD.GetFloat();
                    break;
                case CustomRoles.Eradicator:
                    KillCooldown = Options.DefaultKillCooldown + Options.AcidCreateDuration.GetFloat();
                    break;
                case CustomRoles.Crusader:
                ...
                case CustomRoles.Jackal:
                    ...
                    break;
                case CustomRoles.Mimicker:
                    KillCooldown = Options.MimickerKillCD.GetFloat();
                    break;
                case CustomRoles.Wraith:
                    KillCooldown = Options.WraithKillCD.GetFloat();
                    break;
                case CustomRoles.Glitch:
                    KillCooldown = Options.GlitchKillCD.GetFloat();
                    break;
                case CustomRoles.CorruptedSheriff:
                case CustomRoles.Sheriff:
                case CustomRoles.Deputy:
                ...
                case CustomRoles.Pestilence:
                    ...
                    break;
                case CustomRoles.Cultist:
                    KillCooldown = Options.ConvertCooldown.GetFloat();
                    break;
                case CustomRoles.BloodKnight:
        ...
        public static void StickyKilled(this PlayerControl killer, PlayerControl target)
        {
            Logger.Info($"{target?.Data?.PlayerName}はTrapperだった", "Stick");
            Main.AllPlayerSpeed[killer.PlayerId] = 0.00001f;
            killer.CustomSyncSettings();
            new LateTask(() =>
            {
                ...
                killer.CustomSyncSettings();
                RPC.PlaySoundRPC(killer.PlayerId, Sounds.TaskComplete);
            }, Options.StickTime.GetFloat(), "Sticky Stick");
        }
        ...
        public static void BurstKilled(this PlayerControl killer, PlayerControl target)
        {
            Logger.Info($"{killer?.Data?.PlayerName}はTrapperだった", "KilledDemo");
            Logger.Info($"{target?.Data?.PlayerName}はTrapperだった", "IsDemo");
            //killer.Data.PlayerName += $"<color={Utils.GetRoleColorCode(CustomRoles.Demolitionist)}>▲</color>";
            Main.KilledBurst.Add(killer.PlayerId);
            killer.CustomSyncSettings();
            MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.NotifyDemoKill, Hazel.SendOption.Reliable, -1);
            writer.Write(false);
            writer.Write(killer.PlayerId);
            ...
            new LateTask(() =>
            {
                ...
                if (!GameStates.IsMeeting)
                {
                    Main.KilledBurst.Remove(killer.PlayerId);
                    MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.NotifyBurstKill, Hazel.SendOption.Reliable, -1);
                    writer.Write(true);
                    writer.Write(killer.PlayerId);
                    AmongUsClient.Instance.FinishRpcImmediately(writer);
                    Utils.NotifyRoles(false, killer);
            ...
            }, Options.BurstSuicideTime.GetFloat(), "Bomb Time", true);
        }
        ...
        public static void CanUseImpostorVent(this PlayerControl player)
        {
            switch (player.GetCustomRole())
            {
                ...
                case CustomRoles.Juggernaut:
                    ...
                    return;
                case CustomRoles.Predator:
                    bool pred_canUse = false;
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(pred_canUse && !player.Data.IsDead);
                    player.Data.Role.CanVent = pred_canUse;
                    return;
                case CustomRoles.NeutSerialKiller:
                    bool sk_canUse = Options.SerialKillerCanVent.GetBool();
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(sk_canUse && !player.Data.IsDead);
                    player.Data.Role.CanVent = sk_canUse;
                    return;
                case CustomRoles.Eradicator:
                    bool erad_canUse = Options.SerialKillerCanVent.GetBool();
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(erad_canUse && !player.Data.IsDead && Options.EradicatorCanVent.GetBool());
                    player.Data.Role.CanVent = erad_canUse;
                    return;
                case CustomRoles.Traitor:
                    bool traitor_canUse = true;
                    ...
                    return;
                case CustomRoles.Vindicator:
                    bool vin_canUse = Options.VindicatorCanVent.GetBool();
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(vin_canUse && !player.Data.IsDead);
                    player.Data.Role.CanVent = vin_canUse;
                    return;
                case CustomRoles.Parasite:
                    bool para_canUse = Options.ParasiteCanVent.GetBool();
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(para_canUse && !player.Data.IsDead);
                    player.Data.Role.CanVent = para_canUse;
                    return;
                case CustomRoles.Sidekick:
                case CustomRoles.Jackal:
                    ...
                    return;
                case CustomRoles.Mimicker:
                    bool mimicker_canUse = Options.MimickerCanVent.GetBool();
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(mimicker_canUse && !player.Data.IsDead);
                    player.Data.Role.CanVent = mimicker_canUse;
                    return;
                case CustomRoles.Marksman:
                ...
                case CustomRoles.Wraith:
                    ...
                    return;
                case CustomRoles.Glitch:
                    DestroyableSingleton<HudManager>.Instance.ImpostorVentButton.ToggleVisible(false && !player.Data.IsDead);
                    player.Data.Role.CanVent = false;
                    return;
                case CustomRoles.HexMaster:
                case CustomRoles.CovenWitch:
        ...
        public static string GetDeathMessage(this PlayerControl pc)
        {
            try
            {
                ...
                switch (role)
                {
                    ...
                    case CustomRoles.Sheriff:
                        return $"They were shot by the Sheriff.";
                    case CustomRoles.Deputy:
                    ...
                    case CustomRoles.PoisonMaster:
                        return $"They were poisoned by a Poisoner. (Neutral)";
                    case CustomRoles.Vampire:
                        return $"They were bitten by a Vampire.";
                    case CustomRoles.Eradicator:
                        return $"They were melted by the Eradicator.";
                    case CustomRoles.Sidekick:
                        return $"They were killed by the Jackal's Sidekick.";
                    case CustomRoles.Jackal:
                        return $"They were mauled by the Jackal.";
                    case CustomRoles.Mimicker:
                        return $"They were killed by an Impostor.";
                    case CustomRoles.Wraith:
                        return $"They were tripped over by the Wraith.";
                    case CustomRoles.Glitch:
                        return $"They were corrupted by the Glitch.";
                    case CustomRoles.Pestilence:
                        return $"They were obliterated by Pestilence, Horseman of the Apocalypse.";
                    case CustomRoles.Juggernaut:
                        return $"They were assaulted by a Juggernaut.";
                    case CustomRoles.Predator:
                        return $"They were hunted by a Predator.";
                    case CustomRoles.CrewPostor:
                        return $"They were knocked out by a CrewPostor.";
                    case CustomRoles.NeutSerialKiller:
                        return $"They were stabbed by the Serial Killer.";
                    case CustomRoles.Vindicator:
                        return $"They were eliminated by the Vindicator.";
                    case CustomRoles.Parasite:
                        return $"They were stabbed by a Parasite.";
                    case CustomRoles.Veteran:
        ...
        public static bool IsNeutralKiller(this PlayerControl player)
        {
            ...
            return
                ...
                CustomRoles.Mimicker or
                CustomRoles.Wraith or
                CustomRoles.Glitch or
                CustomRoles.NeutWitch or
                CustomRoles.Sidekick or
                CustomRoles.PlagueBearer or
                CustomRoles.NeutSerialKiller or
