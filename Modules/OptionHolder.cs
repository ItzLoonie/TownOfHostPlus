...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        public static readonly string[] LawyerChangeRoles =
        {
            CustomRoles.Crewmate.ToString(), CustomRoles.Jester.ToString(), CustomRoles.Opportunist.ToString(), CustomRoles.SchrodingerCat.ToString()
        };
        public static readonly CustomRoles[] CRoleLawyerChangeRoles =
        {
            CustomRoles.Crewmate, CustomRoles.Jester, CustomRoles.Opportunist, CustomRoles.SchrodingerCat,
        };
        ...
        public static CustomOption SnitchCanFindMadmates;
        public static CustomOption SpeedBoosterUpSpeed;
        public static CustomOption TrapperBlockMoveTime;
        public static CustomOption StickTime;
        public static CustomOption BurstSuicideTime;
        public static CustomOption BloodTime;
        ...
        // TRICKSTER //
        public static CustomOption TricksterVotes;

        // ERADICATOR //
        public static CustomOption AcidCreateDuration;
        public static CustomOption AcidKillDelay;
        public static CustomOption EradicatorCanVent;
        // SHAPESHIFTER //
        ...
        public static CustomOption AttackCount;
        public static CustomOption IroncladCanSeeWhoTriedToKill;
        ...
        public static CustomOption DisableWaterwheels;
        public static CustomOption DisableWaitingTasks;
        public static CustomOption DisableCleanVent;
        ...
        public static CustomOption GarunteePet; // nice typo, discussions lmao
        ...
        public static OverrideTasksData IroncladTasks;
        public static OverrideTasksData MarshallTasks;
        ...
        public static CustomOption VisibleTaskCounter;
        public static CustomOption BodiesAmount;
        public static CustomOption ModifierRestrict;
        public static CustomOption OverclockedKillCD;
        ...
        // UNDERCOVER //
        public static CustomOption UndercoverKnowsImpostors;
        public static CustomOption ImpostorsKnowUndercover;
        ...
        // MARSHALL //
        public static CustomOption MadmatesSeeMarshall;

        // MAD SNITCH //
        public static CustomOption ImpostorsSeeFinishedMadSnitch;
        ...
        // CULTIST //
        public static CustomOption ConvertCooldown;
        // LAWYER //
        public static CustomOption LawyerKnowsRole;
        public static CustomOption TargetKnowsLawyer;
        public static CustomOption WhenClientDies;
        ...
        // VINDICATOR //
        public static CustomOption VindicatorKillCD;
        public static CustomOption VindicatorCanVent;
        public static CustomOption VindicatorVotes;
        ...
        // Predator //
        public static CustomOption PredatorKillCD;
        public static CustomOption PreysNeeded;

        // Parasite //
        public static CustomOption ParasiteKillCD;
        public static CustomOption ParasiteCanVent;
        public static CustomOption ParasiteCanGuess;
        public static CustomOption ParasiteVotes;
        // Wildling //
        ...
        public static CustomOption SerialKillerKillCD;
        public static CustomOption SerialKillerCanVent;
        public static CustomOption SerialKillerCanGuess;
        ...
        // TRAITOR (NEUTRAL) //
        public static CustomOption TraitorKillCD;
        // FREEZER //
        public static CustomOption FreezerDuration;
        public static CustomOption FreezerCooldown;
        // WISP (CREW SWOOPER) //
        public static CustomOption WispDuration;
        public static CustomOption WispCooldown;
        public static CustomOption WispVision;
        // WRAITH (NEUTRAL SWOOPER) //
        public static CustomOption WraithKillCD;
        public static CustomOption WraithDuration;
        public static CustomOption WraithCooldown;
        // NEW GLITCH ROLE //
        public static CustomOption GlitchKillCD;
        public static CustomOption GlitchCanGuess;
        // HITMAN //
        ...
        // Mimicker //
        public static CustomOption MimickerKillCD;
        public static CustomOption MimickerCanVent;
        // NEUTRAL WITCH //
        ...
        public static void Load()
        {
            ...
            AutoKick = CustomOption.Create(102, Utils.GetRoleColor(CustomRoles.NeutSerialKiller), "AutoKick", AmongUsExtensions.OptionType.GameOption, false, null, true);
            BanInsteadOfKick = CustomOption.Create(103, Utils.GetRoleColor(CustomRoles.Impostor), "BanInsteadOfKick", AmongUsExtensions.OptionType.GameOption, false, AutoKick);
            ...
            //    SetupRoleOptions(1305, CustomRoles.Scientist, AmongUsExtensions.OptionType.Crewmate);
            //   SetupRoleOptions(1307, CustomRoles.GuardianAngel, AmongUsExtensions.OptionType.Crewmate);
            ...
            SetupRoleOptions(99094335, CustomRoles.Trickster, AmongUsExtensions.OptionType.Impostor);
            TricksterVotes = CustomOption.Create(99094337, Color.white, "AdditionalVotes", AmongUsExtensions.OptionType.Impostor, 0, 0, 99, 1, CustomRoleSpawnChances[CustomRoles.Trickster]);
            SetupRoleOptions(2341300, CustomRoles.Eradicator, AmongUsExtensions.OptionType.Impostor);
            AcidCreateDuration = CustomOption.Create(23260010, Color.white, "AcidCreateDuration", AmongUsExtensions.OptionType.Impostor, 15f, 2.5f, 180f, 2.5f, CustomRoleSpawnChances[CustomRoles.Eradicator]);
            AcidKillDelay = CustomOption.Create(2341310, Color.white, "VampireKillDelay", AmongUsExtensions.OptionType.Impostor, 5, 1, 60, 1, CustomRoleSpawnChances[CustomRoles.Eradicator]);
            EradicatorCanVent = CustomOption.Create(2341311, Color.white, "CanVent", AmongUsExtensions.OptionType.Impostor, true, CustomRoleSpawnChances[CustomRoles.Eradicator]);
            ...
            SetupRoleOptions(1500, CustomRoles.Spellcaster, AmongUsExtensions.OptionType.Impostor);
            ...
            SetupSingleRoleOptions(9999, CustomRoles.Grenadier, 1, AmongUsExtensions.OptionType.Impostor, locked: true);
            ...
            SetupRoleOptions(20094335, CustomRoles.IdentityTheft, AmongUsExtensions.OptionType.Impostor, locked: true);
            SetupRoleOptions(20094330, CustomRoles.Pickpocket, AmongUsExtensions.OptionType.Impostor);
            KillsForVote = CustomOption.Create(20094340, Color.white, "KillsForVote", AmongUsExtensions.OptionType.Impostor, 1, 1, 12, 1, CustomRoleSpawnChances[CustomRoles.Pickpocket]);
            VoteAmtOnCompletion = CustomOption.Create(20094341, Color.white, "VoteAmtOnCompletion", AmongUsExtensions.OptionType.Impostor, 1, 1, 99, 1, CustomRoleSpawnChances[CustomRoles.Pickpocket]);
            ...
            SetupSingleRoleOptions(2609, CustomRoles.Silencer, 1, AmongUsExtensions.OptionType.Impostor, locked: true);
            ...
            //    SetupSingleRoleOptions(99969, CustomRoles.Agent, 1, AmongUsExtensions.OptionType.Impostor);
            SetupSingleRoleOptions(696969, CustomRoles.Saboteur, 1, AmongUsExtensions.OptionType.Impostor);
            SetupSingleRoleOptions(10333, CustomRoles.Parasite, 1, AmongUsExtensions.OptionType.Impostor);
            ParasiteKillCD = CustomOption.Create(99910333, Color.white, "KillCD", AmongUsExtensions.OptionType.Impostor, 30, 2.5f, 120, 2.5f, CustomRoleSpawnChances[CustomRoles.Parasite]);
            ParasiteCanVent = CustomOption.Create(99910334, Color.white, "CanVent", AmongUsExtensions.OptionType.Impostor, true, CustomRoleSpawnChances[CustomRoles.Parasite]);
            ParasiteCanGuess = CustomOption.Create(99910335, Color.white, "CanGuess", AmongUsExtensions.OptionType.Impostor, false, CustomRoleSpawnChances[CustomRoles.Parasite]);
            ParasiteVotes = CustomOption.Create(99910337, Color.white, "AdditionalVotes", AmongUsExtensions.OptionType.Impostor, 0, 0, 99, 1, CustomRoleSpawnChances[CustomRoles.Parasite]);
            ...
            //   SetupRoleOptions(20002, CustomRoles.Demolitionist, AmongUsExtensions.OptionType.Crewmate, locked: true);
            ...
            SetupRoleOptions(20850, CustomRoles.Bastion, AmongUsExtensions.OptionType.Crewmate, locked: true);
            BastionVentsRemoveOnBomb = CustomOption.Create(1319, Utils.GetRoleColor(CustomRoles.Bastion), "BastionVentsRemoveOnBomb", AmongUsExtensions.OptionType.Crewmate, true, CustomRoleSpawnChances[CustomRoles.Bastion]);
            ...
            SetupRoleOptions(1304, CustomRoles.Engineer, AmongUsExtensions.OptionType.Crewmate);
            SetupRoleOptions(1307, CustomRoles.Scientist, AmongUsExtensions.OptionType.Crewmate);
            //     SetupRoleOptions(1309, CustomRoles.GuardianAngel, AmongUsExtensions.OptionType.Crewmate);
            SetupRoleOptions(1308, CustomRoles.Marshall, AmongUsExtensions.OptionType.Crewmate);
            MadmatesSeeMarshall = CustomOption.Create(2052068, Utils.GetRoleColor(CustomRoles.Madmate), "RevealsToMadmates", AmongUsExtensions.OptionType.Crewmate, false, CustomRoleSpawnChances[CustomRoles.Marshall]);
            MarshallTasks = OverrideTasksData.Create(2052069, CustomRoles.Marshall, AmongUsExtensions.OptionType.Crewmate);
            ...
            MadmatesAreEvil = CustomOption.Create(1315, Utils.GetRoleColor(CustomRoles.Madmate), "MadMateIsRed", AmongUsExtensions.OptionType.Crewmate, true, CustomRoleSpawnChances[CustomRoles.Psychic]);
            GAdependsOnTaregtRole = CustomOption.Create(1316, Utils.GetRoleColor(CustomRoles.GuardianAngelTOU), "GAdependsOnTaregtRole", AmongUsExtensions.OptionType.Crewmate, true, CustomRoleSpawnChances[CustomRoles.Psychic]);
            ExeTargetShowsEvil = CustomOption.Create(1317, Utils.GetRoleColor(CustomRoles.Executioner), "ExeTargetShowsEvil", AmongUsExtensions.OptionType.Crewmate, true, CustomRoleSpawnChances[CustomRoles.Psychic]);
            SetupSingleRoleOptions(20010, CustomRoles.Veteran, 1, AmongUsExtensions.OptionType.Crewmate, locked: true);
            ...
            DetectiveArrow = CustomOption.Create(9920602, Utils.GetRoleColor(CustomRoles.Detective), "DetectiveHasArrow", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Detective]);
            SetupRoleOptions(20100, CustomRoles.Lighter, AmongUsExtensions.OptionType.Crewmate);
            LighterTaskCompletedVision = CustomOption.Create(20110, Utils.GetRoleColor(CustomRoles.Lighter), "LighterTaskCompletedVision", AmongUsExtensions.OptionType.Crewmate, 2f, 0f, 5f, 0.25f, CustomRoleSpawnChances[CustomRoles.Lighter]);
            LighterTaskCompletedDisableLightOut = CustomOption.Create(20111, Utils.GetRoleColor(CustomRoles.Lighter), "LighterTaskCompletedDisableLightOut", AmongUsExtensions.OptionType.Crewmate, true, CustomRoleSpawnChances[CustomRoles.Lighter]);
            SetupRoleOptions(20200, CustomRoles.Mayor, AmongUsExtensions.OptionType.Crewmate);
            MayorAdditionalVote = CustomOption.Create(20210, Utils.GetRoleColor(CustomRoles.Mayor), "MayorAdditionalVote", AmongUsExtensions.OptionType.Crewmate, 1, 1, 99, 1, CustomRoleSpawnChances[CustomRoles.Mayor]);
            ...
            MayorHasPortableButton = CustomOption.Create(20211, Utils.GetRoleColor(CustomRoles.Mayor), "MayorHasPortableButton", AmongUsExtensions.OptionType.Crewmate, false, CustomRoleSpawnChances[CustomRoles.Mayor]);
            MayorNumOfUseButton = CustomOption.Create(20212, Utils.GetRoleColor(CustomRoles.Mayor), "MayorNumOfUseButton", AmongUsExtensions.OptionType.Crewmate, 1, 1, 99, 1, MayorHasPortableButton);
            //       SabotageMaster.SetupCustomOption();
            Sheriff.SetupCustomOption();
            Investigator.SetupCustomOption();
            SetupRoleOptions(99910100, CustomRoles.Ironclad, AmongUsExtensions.OptionType.Crewmate);
            IroncladCanSeeWhoTriedToKill = CustomOption.Create(99910110, Utils.GetRoleColor(CustomRoles.Ironclad), "IroncladCanSeeWhoTriedToKill", AmongUsExtensions.OptionType.Crewmate, false, CustomRoleSpawnChances[CustomRoles.Ironclad]);
            IroncladTasks = OverrideTasksData.Create(99910120, CustomRoles.Ironclad, AmongUsExtensions.OptionType.Crewmate);
            ...
            SnitchCanFindNeutralKiller = CustomOption.Create(20512, Utils.GetRoleColor(CustomRoles.Jackal), "SnitchCanFindNeutralKiller", AmongUsExtensions.OptionType.Crewmate, false, CustomRoleSpawnChances[CustomRoles.Snitch]);
            SnitchCanFindCoven = CustomOption.Create(20513, Utils.GetRoleColor(CustomRoles.Coven), "SnitchCanFindCoven", AmongUsExtensions.OptionType.Crewmate, false, CustomRoleSpawnChances[CustomRoles.Snitch]);
            SnitchCanFindMadmates = CustomOption.Create(20514, Utils.GetRoleColor(CustomRoles.Madmate), "SnitchCanFindMadmates", AmongUsExtensions.OptionType.Crewmate, false, CustomRoleSpawnChances[CustomRoles.Snitch]);
            //20520~20523を使用
            SnitchTasks = OverrideTasksData.Create(20520, CustomRoles.Snitch, AmongUsExtensions.OptionType.Crewmate);
            SetupRoleOptions(1214002, CustomRoles.Crusader, AmongUsExtensions.OptionType.Crewmate, locked: true);
            ...
            DictatesUntilSuicde = CustomOption.Create(20902, Utils.GetRoleColor(CustomRoles.Dictator), "DictatesUntilSuicde", AmongUsExtensions.OptionType.Crewmate, 1, 1, 15, 1, CustomRoleSpawnChances[CustomRoles.Dictator]);

            SetupSingleRoleOptions(9992600, CustomRoles.Wisp, 1, AmongUsExtensions.OptionType.Crewmate, locked: true);
            WispVision = CustomOption.Create(999260012, Color.white, "WispVision", AmongUsExtensions.OptionType.Crewmate, 0.75f, 0f, 5f, 0.25f, CustomRoleSpawnChances[CustomRoles.Wisp]);
            WispDuration = CustomOption.Create(999260010, Color.white, "WispDuration", AmongUsExtensions.OptionType.Crewmate, 15f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.Wisp]);
            WispCooldown = CustomOption.Create(999260011, Color.white, "WispCooldown", AmongUsExtensions.OptionType.Crewmate, 30f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.Wisp]);
            ...
            SetupRoleOptions(30010, CustomRoles.Imp, AmongUsExtensions.OptionType.Impostor);
            ...
            SetupSingleRoleOptions(90900, CustomRoles.Masochist, 1, AmongUsExtensions.OptionType.Neutral);
            AttackCount = CustomOption.Create(60032, Color.white, "MasochistAttackCount", AmongUsExtensions.OptionType.Neutral, 3, 1, 15, 1, CustomRoleSpawnChances[CustomRoles.Masochist]);
            ...
            SetupSingleRoleOptions(7000099, CustomRoles.Predator, 1, AmongUsExtensions.OptionType.Neutral);
            PredatorKillCD = CustomOption.Create(7000100, Color.white, "KillCD", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 120, 2.5f, CustomRoleSpawnChances[CustomRoles.Predator]);
            PreysNeeded = CustomOption.Create(7000101, Color.white, "VultureVent", AmongUsExtensions.OptionType.Neutral, 3, 1, 10, 1, CustomRoleSpawnChances[CustomRoles.Predator]);
            SetupRoleOptions(2344334, CustomRoles.Opportunist, AmongUsExtensions.OptionType.Neutral);
            SetupRoleOptions(50100, CustomRoles.Survivor, AmongUsExtensions.OptionType.Neutral, locked: true);
            ...
            VultureCanVent = CustomOption.Create(6000017, Color.white, "CanVent", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Vulture]);
            ...
            VultureArrow = CustomOption.Create(6000019, Utils.GetRoleColor(CustomRoles.Vulture), "VultureHasArrow", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Vulture]);
            SetupSingleRoleOptions(9054300, CustomRoles.GuardianAngelTOU, 1, AmongUsExtensions.OptionType.Neutral, locked: true);
            ...
            SetupSingleRoleOptions(129054300, CustomRoles.Lawyer, 1, AmongUsExtensions.OptionType.Neutral);
            //     LawyerKnowsRole = CustomOption.Create(129054301, Color.white, "LawyerKnowsRole", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.Lawyer]);
            //    TargetKnowsLawyer = CustomOption.Create(129054302, Color.white, "TargetKnowsLawyer", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.Lawyer]);
            WhenClientDies = CustomOption.Create(129054303, Color.white, "WhenClientDies", AmongUsExtensions.OptionType.Neutral, LawyerChangeRoles, LawyerChangeRoles[2], CustomRoleSpawnChances[CustomRoles.Lawyer]);
            LawyerHasImpostorVision = CustomOption.Create(129054304, Color.white, "HasImpostorVision", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Lawyer]);
            JesterCanBeClient = CustomOption.Create(129054305, Utils.GetRoleColor(CustomRoles.Jester), "JesterCanBeClient", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Lawyer]);
            SnitchCanBeClient = CustomOption.Create(129054306, Utils.GetRoleColor(CustomRoles.Snitch), "SnitchCanBeClient", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Lawyer]);
            ...
            HitmanCanWinWithExeJes = CustomOption.Create(509139, Utils.GetRoleColor(CustomRoles.Jester), "HitmanCanWinWithExeJes", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Hitman]);

            SetupRoleOptions(50400, CustomRoles.SchrodingerCat, AmongUsExtensions.OptionType.Neutral);
            CanBeforeSchrodingerCatWinTheCrewmate = CustomOption.Create(50410, Utils.GetRoleColor(CustomRoles.Crewmate), "CanBeforeSchrodingerCatWinTheCrewmate", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.SchrodingerCat]);
            ...
            //     SetupRoleOptions(569690000, CustomRoles.Mimicker, AmongUsExtensions.OptionType.Neutral);
            //     MimickerKillCD = CustomOption.Create(569690001, Color.white, "KillCD", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.Mimicker]);
            //     MimickerCanVent = CustomOption.Create(569690002, Color.white, "CanVent", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.Mimicker]);
            ...
            ExecutionerCanTargetImpostor = CustomOption.Create(50710, Utils.GetRoleColor(CustomRoles.Impostor), "ExecutionerCanTargetImpostor", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Executioner]);
            ...
            InfectionSkip = CustomOption.Create(50563, Utils.GetRoleColor(CustomRoles.Pestilence), "SkipInfect", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.PlagueBearer]);
            ...
            SetupSingleRoleOptions(96950900, CustomRoles.Vindicator, 1, AmongUsExtensions.OptionType.Neutral);
            VindicatorKillCD = CustomOption.Create(96950901, Color.white, "KillCD", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.Vindicator]);
            VindicatorCanVent = CustomOption.Create(96950902, Color.white, "CanVent", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.Vindicator]);
            VindicatorVotes = CustomOption.Create(96950903, Color.white, "AdditionalVotes", AmongUsExtensions.OptionType.Neutral, 1, 1, 99, 1, CustomRoleSpawnChances[CustomRoles.Vindicator]);
            SetupSingleRoleOptions(6950900, CustomRoles.NeutSerialKiller, 1, AmongUsExtensions.OptionType.Neutral);
            SerialKillerKillCD = CustomOption.Create(6950901, Color.white, "KillCD", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.NeutSerialKiller]);
            SerialKillerCanVent = CustomOption.Create(6950902, Color.white, "CanVent", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.NeutSerialKiller]);
            SerialKillerCanGuess = CustomOption.Create(6950903, Color.white, "CanGuess", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.NeutSerialKiller]);
            ...
            JackalHasSidekick = CustomOption.Create(50914, Utils.GetRoleColor(CustomRoles.Sidekick), "JackalHasSidekick", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Jackal]);
            ...
            SetupSingleRoleOptions(99950918, CustomRoles.Traitor, 1, AmongUsExtensions.OptionType.Neutral);
            TraitorKillCD = CustomOption.Create(99950919, Color.white, "KillCD", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 120, 2.5f, CustomRoleSpawnChances[CustomRoles.Traitor]);
            ...
            SetupSingleRoleOptions(6962600, CustomRoles.Glitch, 1, AmongUsExtensions.OptionType.Neutral);
            GlitchKillCD = CustomOption.Create(696260009, Color.white, "KillCD", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 120, 2.5f, CustomRoleSpawnChances[CustomRoles.Glitch]);
            SetupSingleRoleOptions(9692600, CustomRoles.Wraith, 1, AmongUsExtensions.OptionType.Neutral);
            WraithKillCD = CustomOption.Create(969260009, Color.white, "KillCD", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 120, 2.5f, CustomRoleSpawnChances[CustomRoles.Wraith]);
            //     WraithDuration = CustomOption.Create(969260010, Color.white, "WraithDuration", AmongUsExtensions.OptionType.Impostor, 30f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.Wraith]);
            //     WraithCooldown = CustomOption.Create(969260011, Color.white, "WraithCooldown", AmongUsExtensions.OptionType.Impostor, 15f, 2.5f, 60f, 2.5f, CustomRoleSpawnChances[CustomRoles.Wraith]);

            SetupSingleRoleOptions(80500, CustomRoles.TheGlitch, 1, AmongUsExtensions.OptionType.Neutral, locked: true);
            ...
            SetupSingleRoleOptions(90050, CustomRoles.Werewolf, 1, AmongUsExtensions.OptionType.Neutral, locked: true);
            ...
            SetupSingleRoleOptions(9920800, CustomRoles.Overclocked, 1, AmongUsExtensions.OptionType.Modifier);
            OverclockedKillCD = CustomOption.Create(9920802, Utils.GetRoleColor(CustomRoles.Overclocked), "KillCD", AmongUsExtensions.OptionType.Modifier, 30, 2.5f, 120, 2.5f, CustomRoleSpawnChances[CustomRoles.Overclocked]);
            QuickFix.SetupCustomOption();
            SetupSingleRoleOptions(29729, CustomRoles.Burst, 1, AmongUsExtensions.OptionType.Modifier);
            BurstSuicideTime = CustomOption.Create(20004, Utils.GetRoleColor(CustomRoles.Burst), "BombSuicideTime", AmongUsExtensions.OptionType.Modifier, 5f, 1f, 60, 1, CustomRoleSpawnChances[CustomRoles.Burst]);
            SetupSingleRoleOptions(20800, CustomRoles.Sticky, 1, AmongUsExtensions.OptionType.Modifier);
            StickTime = CustomOption.Create(20810, Utils.GetRoleColor(CustomRoles.Sticky), "StickTime", AmongUsExtensions.OptionType.Modifier, 10f, 1f, 60, 1, CustomRoleSpawnChances[CustomRoles.Sticky]);
            SetupSingleRoleOptions(200045, CustomRoles.Torch, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(9920890, CustomRoles.Amplify, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(20000, CustomRoles.Bait, 1, AmongUsExtensions.OptionType.Modifier);
            //      SetupSingleRoleOptions(200011, CustomRoles.Bloody, 1, AmongUsExtensions.OptionType.Modifier);
            //     BloodTime = CustomOption.Create(200012, Color.white, "BloodTime", AmongUsExtensions.OptionType.Modifier, 10f, 1f, 60, 1, CustomRoleSpawnChances[CustomRoles.Bloody]);
            SetupSingleRoleOptions(20000000, CustomRoles.Eternal, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(9920005, CustomRoles.Blind, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(20005, CustomRoles.Bewilder, 1, AmongUsExtensions.OptionType.Modifier);
            BewilderVision = CustomOption.Create(20020, Utils.GetRoleColor(CustomRoles.Bewilder), "BewilderVision", AmongUsExtensions.OptionType.Modifier, 0.5f, 0f, 5f, 0.25f, CustomRoleSpawnChances[CustomRoles.Bewilder]);
            SetupSingleRoleOptions(2000266, CustomRoles.Diseased, 1, AmongUsExtensions.OptionType.Modifier);
            DiseasedMultiplier = CustomOption.Create(20021, Utils.GetRoleColor(CustomRoles.Diseased), "DiseasedMultiplier", AmongUsExtensions.OptionType.Modifier, 2f, 1.5f, 5f, 0.25f, CustomRoleSpawnChances[CustomRoles.Diseased]);

            SetupSingleRoleOptions(200025, CustomRoles.Oblivious, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(299900025, CustomRoles.Undercover, 1, AmongUsExtensions.OptionType.Modifier);
            UndercoverKnowsImpostors = CustomOption.Create(299900026, Utils.GetRoleColor(CustomRoles.Undercover), "KnowsImpostors", AmongUsExtensions.OptionType.Modifier, false, CustomRoleSpawnChances[CustomRoles.Undercover]);
            ImpostorsKnowUndercover = CustomOption.Create(299900027, Utils.GetRoleColor(CustomRoles.Undercover), "KnownToImpostors", AmongUsExtensions.OptionType.Modifier, false, CustomRoleSpawnChances[CustomRoles.Undercover]);
            SetupSingleRoleOptions(9900026, CustomRoles.Insight, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(9900027, CustomRoles.Outsight, 1, AmongUsExtensions.OptionType.Modifier);
            ...
            FlashSpeed = CustomOption.Create(200305, Utils.GetRoleColor(CustomRoles.Flash), "SpeedBoosterUpSpeed", AmongUsExtensions.OptionType.Modifier, 2f, 0.25f, 3f, 0.25f, CustomRoleSpawnChances[CustomRoles.Flash]);
            SetupSingleRoleOptions(30100, CustomRoles.Sleuth, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(9930102, CustomRoles.Necroview, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(9930101, CustomRoles.Forensic, 1, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(9930100, CustomRoles.Tethered, 1, AmongUsExtensions.OptionType.Modifier);
            ...
            SetupSingleRoleOptions(5030069, CustomRoles.Chainlink, 2, AmongUsExtensions.OptionType.Modifier);
            SetupSingleRoleOptions(50300, CustomRoles.LoversRecode, 2, AmongUsExtensions.OptionType.Modifier);
            LoversDieTogether = CustomOption.Create(503005, Utils.GetRoleColor(CustomRoles.LoversRecode), "LoversDieTogether", AmongUsExtensions.OptionType.Modifier, false, CustomRoleSpawnChances[CustomRoles.LoversRecode]);
            LoversKnowRoleOfOtherLover = CustomOption.Create(503005, Utils.GetRoleColor(CustomRoles.LoversRecode), "LoversKnowRoleOfOtherLover", AmongUsExtensions.OptionType.Modifier, true, CustomRoleSpawnChances[CustomRoles.LoversRecode]);
            //EvilWatcherChance = CustomOption.Create(30010, Color.white, "EvilWatcherChance", 0, 0, 100, 10, CustomRoleSpawnChances[CustomRoles.Watcher]);
            ...
            ModifierRestrict = CustomOption.Create(1314, Color.white, "ModifierRestrict", AmongUsExtensions.OptionType.GameOption, true, null, true)
                .SetGameMode(CustomGameMode.Standard);
            ImpostorKnowsRolesOfTeam = CustomOption.Create(102000, Utils.GetRoleColor(CustomRoles.Impostor), "ImpostorKnowsRolesOfTeam", AmongUsExtensions.OptionType.GameOption, true, null, true)
                .SetGameMode(CustomGameMode.Standard);
            CovenKnowsRolesOfTeam = CustomOption.Create(102300, Utils.GetRoleColor(CustomRoles.Coven), "CovenKnowsRolesOfTeam", AmongUsExtensions.OptionType.GameOption, true, null, true)
                .SetGameMode(CustomGameMode.Standard);
            ...
            .SetGameMode(CustomGameMode.All);
            RolesLikeToU = CustomOption.Create(1020000, Color.white, "RolesLikeToU", AmongUsExtensions.OptionType.GameOption, false, null, false)
            .SetGameMode(CustomGameMode.All);
            ...
            DisableFixWiring = CustomOption.Create(100307, Color.white, "DisableFixWiring", AmongUsExtensions.OptionType.GameOption, false, DisableTasks)
                .SetGameMode(CustomGameMode.All);
            DisableWaterwheels = CustomOption.Create(100308, Color.white, "DisableWaterwheels", AmongUsExtensions.OptionType.GameOption, false, DisableTasks)
                .SetGameMode(CustomGameMode.All);
            DisableWaitingTasks = CustomOption.Create(100309, Color.white, "DisableWaitingTasks", AmongUsExtensions.OptionType.GameOption, false, DisableTasks)
                .SetGameMode(CustomGameMode.All);
            DisableCleanVent = CustomOption.Create(100310, Color.white, "DisableCleanVent", AmongUsExtensions.OptionType.GameOption, false, DisableTasks)
                .SetGameMode(CustomGameMode.All);
            ...
            EnableHiddenRoles = CustomOption.Create(100610, Utils.GetRoleColor(CustomRoles.Escalation), "EnableHiddenRoles", AmongUsExtensions.OptionType.GameOption, true, null, true)
                .SetGameMode(CustomGameMode.Standard);
            ChangeNameToRoleInfo = CustomOption.Create(100611, Utils.GetRoleColor(CustomRoles.Marshall), "ShowRoleDescription", AmongUsExtensions.OptionType.GameOption, true, null, true)
    .SetGameMode(CustomGameMode.Standard);
            ...
            GhostCanSeeOtherVotes = CustomOption.Create(100604, Color.white, "GhostCanSeeOtherVotes", AmongUsExtensions.OptionType.GameOption, true)
                .SetGameMode(CustomGameMode.All);
            VisibleTaskCounter = CustomOption.Create(100610, Color.white, "VisibleTaskCounter", AmongUsExtensions.OptionType.GameOption, true)
                .SetGameMode(CustomGameMode.All);
        ...
        public static void SetupSingleRoleOptions(int id, CustomRoles role, int count, AmongUsExtensions.OptionType type, CustomGameMode customGameMode = CustomGameMode.Standard, bool locked = false, bool crewmate = false, bool madmate = false, bool neutral = false, bool modifier = false)
        {
            var spawnOption = CustomOption.Create(id, locked ? Utils.GetRoleColor(CustomRoles.Target) : Utils.GetRoleColor(role), role.ToString(), type, rates, rates[0], null, true)
                .HiddenOnDisplay(true)
                .SetGameMode(customGameMode);
