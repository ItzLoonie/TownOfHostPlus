...
namespace TownOfHost
{
    public class CustomOption
    {
        ...
        public CustomOption SetImpostor(bool broken)
        {
            Broken = broken;
            return this;
        }
        public CustomOption SetCrewmate(bool broken)
        {
            Broken = broken;
            return this;
        }
        public CustomOption SetMadmate(bool broken)
        {
            Broken = broken;
            return this;
        }
        public CustomOption SetNeutral(bool broken)
        {
            Broken = broken;
            return this;
        }
        public CustomOption SetModifier(bool broken)
        {
            Broken = broken;
            return this;
        }
