...
namespace TownOfHost
{
    ...
    public static class SetRecommendationsPatch
    {
        public static bool Prefix(NormalGameOptionsV07 __instance, int numPlayers, bool isOnline)
        {
            ...
            __instance.GetGuardianAngelOptions().ProtectionDurationSeconds = 5f;
            __instance.GetGuardianAngelOptions().GuardianAngelCooldown = 30f;
            //     __instance.GetGuardianAngelOptions().
            ...
            __instance.GetEngineerOptions().EngineerInVentMaxTime = 0f;
