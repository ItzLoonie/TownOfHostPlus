...
namespace TownOfHost
{
    ...
    public class MainMenuManagerPatch
    {
        ...
        public static void Start_Prefix(MainMenuManager __instance)
        {
            ...
            updatePassiveButton.OnClick.AddListener((Action)(() => Application.OpenURL("https://github.com/SkullCreeper/TownOfHostPlus")));
            ...
            if (freeplayButton != null)
            {
                ...
                freeplayButton.GetComponent<PassiveButton>().OnClick.AddListener((Action)(() => Application.OpenURL("https://github.com/SkullCreeper/TownOfHostPlus")));
