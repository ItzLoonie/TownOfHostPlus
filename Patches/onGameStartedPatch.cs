    ...
    class ChangeRoleSettings
    {
        public static void Postfix(AmongUsClient __instance)
        {
            try
            {
                ...
                Main.AcidatedPlayers = new Dictionary<byte, (byte, float)>();
                ...
                Main.LawyerTarget = new Dictionary<byte, byte>();
                ...
                Main.ChainedPlayers = new List<PlayerControl>();
                ...
                Main.DetectiveReported = new();
                Main.TricksterReported = new();
                //名前の記録
    ...
    class SelectRolesPatch
    {
            ...
            try
            {
                ...
                if (Options.CurrentGameMode() != CustomGameMode.HideAndSeek)
                {
                    ...
                    if (Options.MaxNK.GetInt() != 0)
                    {
                        ...
                        if (RoleGoingInList(CustomRoles.Mimicker))
                            rolesChosen.Add(CustomRoles.Mimicker);
                        ...
                        if (RoleGoingInList(CustomRoles.NeutSerialKiller))
                            rolesChosen.Add(CustomRoles.NeutSerialKiller);

                        if (RoleGoingInList(CustomRoles.Wraith))
                            rolesChosen.Add(CustomRoles.Wraith);

                        if (RoleGoingInList(CustomRoles.Glitch))
                            rolesChosen.Add(CustomRoles.Glitch);

                        if (RoleGoingInList(CustomRoles.Traitor))
                            rolesChosen.Add(CustomRoles.Traitor);

                        if (RoleGoingInList(CustomRoles.Vindicator))
                            rolesChosen.Add(CustomRoles.Vindicator);
                    ...
                    if (Options.MaxNonNK.GetInt() != 0)
                    {
                        ...
                        if (RoleGoingInList(CustomRoles.Predator))
                            rolesChosenNon.Add(CustomRoles.Predator);

                        if (RoleGoingInList(CustomRoles.GuardianAngelTOU))
                            rolesChosenNon.Add(CustomRoles.GuardianAngelTOU);

                        if (RoleGoingInList(CustomRoles.Lawyer))
                            rolesChosenNon.Add(CustomRoles.Lawyer);
                        ...
                        if (rolesChosenNon.Count != 0)
                            if (numofNonNks != 0)
                                for (var i = 0; i < numofNonNks; i++)
                                {
                                    ...
                                    else if (role is CustomRoles.Amnesiac or CustomRoles.Hitman or CustomRoles.Predator)
                                    {
                                        List<PlayerControl> urself = new();
                                        urself.Add(player);
                                        AssignDesyncRole(role, urself, sender, BaseRole: RoleTypes.Impostor);
                        ...
                        else
                        {
                            if (role.IsCrewmate() && role.IsEnable())
                            {
                                ...
                                for (var i = 0; i < role.GetCount(); i++)
                                {
                                    ...
                                    {
                                        chosenCrew.Add(role);
                                        if (role is CustomRoles.Sheriff) deputySpawn = true;
                        ...
                        if (crewnum > 0)
                            for (var i = 0; i < crewnum; i++)
                            {
                                ...
                                if (role.IsDesyncRole())
                                    ...
                                    Main.chosenEngiRoles.Add(role);
                                else if (role is CustomRoles.Doctor or CustomRoles.Physicist or CustomRoles.Scientist)
                    ...
                    if (deputySpawn)
                        if (Sheriff.SheriffHasDeputy.GetBool())
                            ForceAssignRole(CustomRoles.Deputy, AllPlayers, sender, Count: 1, BaseRole: RoleTypes.Impostor);
                    ...
                    if (Main.chosenDesyncRoles.Contains(CustomRoles.GuardianAngel))
                        AssignDesyncRole(CustomRoles.GuardianAngel, AllPlayers, sender, BaseRole: RoleTypes.GuardianAngel);
                    if (Main.chosenDesyncRoles.Contains(CustomRoles.Parasite))
                        AssignDesyncRole(CustomRoles.Parasite, AllPlayers, sender, BaseRole: RoleTypes.Impostor);
                    if (Main.chosenDesyncRoles.Contains(CustomRoles.Consigliere))
                        AssignDesyncRole(CustomRoles.Consigliere, AllPlayers, sender, BaseRole: RoleTypes.Impostor);
                    if (Main.chosenDesyncRoles.Contains(CustomRoles.Cultist))
                        AssignDesyncRole(CustomRoles.Cultist, AllPlayers, sender, BaseRole: RoleTypes.Impostor);
                    ...
                    if (Main.chosenDesyncRoles.Contains(CustomRoles.Saboteur))
                        AssignDesyncRole(CustomRoles.Saboteur, AllPlayers, sender, BaseRole: RoleTypes.Impostor);
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (RoleGoingInList(CustomRoles.LoversRecode))
                        AssignLoversRoles(2);
                    if (RoleGoingInList(CustomRoles.Chainlink))
                        AssignChainlinks(2);
                    ...
                    if (RoleGoingInList(CustomRoles.Assassin))
                        GiveModifier(CustomRoles.Assassin);
                    if (RoleGoingInList(CustomRoles.Bloody))
                        GiveModifier(CustomRoles.Bloody);
                    if (RoleGoingInList(CustomRoles.Guesser))
                        GiveModifier(CustomRoles.Guesser);
                    if (RoleGoingInList(CustomRoles.Eternal))
                        GiveModifier(CustomRoles.Eternal);
                    if (RoleGoingInList(CustomRoles.Forensic))
                        GiveModifier(CustomRoles.Forensic);
                    if (RoleGoingInList(CustomRoles.Necroview))
                        GiveModifier(CustomRoles.Necroview);
                    if (RoleGoingInList(CustomRoles.Tethered))
                        GiveModifier(CustomRoles.Tethered);
                    if (RoleGoingInList(CustomRoles.QuickFix))
                        GiveModifier(CustomRoles.QuickFix);
                    if (RoleGoingInList(CustomRoles.Bewilder))
                        GiveModifier(CustomRoles.Bewilder);
                    if (RoleGoingInList(CustomRoles.Blind))
                        GiveModifier(CustomRoles.Blind);
                    ...
                    if (RoleGoingInList(CustomRoles.Sticky))
                        GiveModifier(CustomRoles.Sticky);
                    if (RoleGoingInList(CustomRoles.Burst))
                        GiveModifier(CustomRoles.Burst);
                    if (RoleGoingInList(CustomRoles.Overclocked))
                        GiveModifier(CustomRoles.Overclocked);
                    if (RoleGoingInList(CustomRoles.Amplify))
                        GiveModifier(CustomRoles.Amplify);
                    if (RoleGoingInList(CustomRoles.Insight))
                        GiveModifier(CustomRoles.Insight);
                    if (RoleGoingInList(CustomRoles.Outsight))
                        GiveModifier(CustomRoles.Outsight);
                    ...
                    if (RoleGoingInList(CustomRoles.Undercover))
                        GiveModifier(CustomRoles.Undercover);
                    ...
                    foreach (var pc in PlayerControl.AllPlayerControls)
                    {
                        ...
                        switch (pc.GetCustomRole())
                        {
                            ...
                            case CustomRoles.Lawyer:
                                List<PlayerControl> clientList = new();
                                rand = new System.Random();
                                foreach (var target in PlayerControl.AllPlayerControls)
                                {
                                    if (pc == target) continue;
                                    if (target.Is(CustomRoles.Phantom)) continue;
                                    if (target.Is(CustomRoles.GM)) continue;
                                    if (target.Is(CustomRoles.Jester) && !Options.JesterCanBeClient.GetBool()) continue;
                                    if (target.Is(CustomRoles.Snitch) && !Options.SnitchCanBeClient.GetBool()) continue;
                                    if (target.GetCustomRole().IsNonNk() && !target.Is(CustomRoles.Jester)) continue;
                                    if (target.GetCustomRole().IsCoven()) continue;
                                    if (target.GetCustomRole().IsCrewmate() && !target.Is(CustomRoles.Snitch)) continue;
                                    if (target.GetCustomRole().IsMadmate()) continue;



                                    clientList.Add(target);
                                }
                                var Killer = clientList[rand.Next(clientList.Count)];
                                Main.LawyerTarget.Add(pc.PlayerId, Killer.PlayerId);
                                RPC.SendLawyerTarget(pc.PlayerId, Killer.PlayerId);
                                Logger.Info($"{pc.GetNameWithRole()}:{Killer.GetNameWithRole()}", "Lawyer");
                                break;
                            ...
                            case CustomRoles.SabotageMaster:
                                ...
                                break;
                            case CustomRoles.QuickFix:
                                QuickFix.Add(pc.PlayerId);
                                break;
                            ...
                            case CustomRoles.Consigliere:
                                ...
                                foreach (var ar in PlayerControl.AllPlayerControls)
                                {
                                    Consigliere.hasSeered.Add(ar.PlayerId, false);
                                }
                                break;
        ...
        private static void AssignLoversRoles(int RawCount = -1)
        {
            ...
            foreach (var player in PlayerControl.AllPlayerControls)
            {
                ...
                if (player.Is(CustomRoles.Imp)) continue;
        ...
        private static void AssignChainlinks(int RawCount = -1)
        {
            var allPlayers = new List<PlayerControl>();
            foreach (var player in PlayerControl.AllPlayerControls)
            {
            ...
            var chainedRole = CustomRoles.Chainlink;
            var rand = new System.Random();
            var count = Math.Clamp(RawCount, 0, allPlayers.Count);
            if (RawCount == -1) count = Math.Clamp(chainedRole.GetCount(), 0, allPlayers.Count);
            if (count <= 0) return;
            ...
            var player2 = allPlayers[rand.Next(0, allPlayers.Count)];
            allPlayers.Remove(player2);
            List<PlayerControl> chained = new();
            chained.Add(player1);
            chained.Add(player2);
            ...
            if (player1 && player2 != null)
                for (var i = 0; i < count; i++)
                {
                    var player = chained[rand.Next(0, chained.Count)];
                    Main.ChainedPlayers.Add(player);
                    chained.Remove(player);
                    Main.AllPlayerCustomSubRoles[player.PlayerId] = chainedRole;
                    Main.HasModifier.Add(player.PlayerId, chainedRole);
                    Logger.Info("役職設定:" + player?.Data?.PlayerName + " = " + player.GetCustomRole().ToString() + " + " + chainedRole.ToString(), "AssignChainlinks");
                }
            RPC.SyncChainedPlayers();
        }
        ...
        private static void GiveModifier(CustomRoles role, int RawCount = -1)
        {
            ...
            foreach (var player in PlayerControl.AllPlayerControls)
            {
                ...
                if (Main.AllPlayerCustomRoles[player.PlayerId] == CustomRoles.Chainlink) continue;
                if (Main.HasModifier.ContainsKey(player.PlayerId)) continue;
                if (player.Is(CustomRoles.Phantom)) continue;
                    ...
                    if (player.Is(CustomRoles.GM)) continue;
                {
                    switch (role)
                    {
                        ...
                        case CustomRoles.Oblivious:
                            if (player.GetCustomRole() is CustomRoles.Medium or CustomRoles.Wraith or CustomRoles.Detective or CustomRoles.Amnesiac or CustomRoles.Vulture or CustomRoles.Cleaner) continue;
                            break;
                        case CustomRoles.QuickFix:
                            if (player.GetCustomRole() is CustomRoles.Hacker or CustomRoles.SabotageMaster or CustomRoles.Madmate or CustomRoles.MadGuardian or CustomRoles.MadSnitch or CustomRoles.SKMadmate or CustomRoles.Consigliere or CustomRoles.Parasite) continue;
                            break;
                        ...
                        case CustomRoles.Bait:
                            if (player.GetCustomRole() is CustomRoles.Trapper or CustomRoles.Masochist or CustomRoles.Child) continue;
                            break;
                        case CustomRoles.Guesser:
                            if (player.GetCustomRole() is CustomRoles.NeutSerialKiller or CustomRoles.Pirate or CustomRoles.Parasite or CustomRoles.Assassin or CustomRoles.Vigilante) continue;
                            break;
                        case CustomRoles.Undercover:
                            if (player.GetCustomRole() is CustomRoles.Sheriff or CustomRoles.Ironclad or CustomRoles.Investigator or CustomRoles.Snitch or CustomRoles.Spy or CustomRoles.NeutWitch or CustomRoles.Opportunist or CustomRoles.Survivor or CustomRoles.SchrodingerCat or CustomRoles.Executioner or CustomRoles.GuardianAngelTOU or CustomRoles.Lawyer) continue;
                            if (player.GetRoleType() is RoleType.Impostor or RoleType.Crewmate or RoleType.Coven or RoleType.Madmate) continue;
                            if (player.GetCustomRole().IsNonNk()) continue;
                            break;
                        case CustomRoles.Bewilder:
                            if (player.GetCustomRole() is CustomRoles.Trapper or CustomRoles.Masochist or CustomRoles.Child) continue;
                            break;
                        case CustomRoles.Forensic:
                            if (player.GetCustomRole() is CustomRoles.Doctor or CustomRoles.Trickster) continue;
                            break;
                        case CustomRoles.Necroview:
                            if (player.GetCustomRole() is CustomRoles.Doctor or CustomRoles.Trickster) continue;
                            break;
                        case CustomRoles.DoubleShot:
                            if (player.GetCustomRole() is not CustomRoles.Assassin and not CustomRoles.Vigilante) continue;
                            break;
                        case CustomRoles.Torch:
                            if (player.GetCustomRole() is CustomRoles.Spy or CustomRoles.Lighter or CustomRoles.Jester) continue;
                            break;
                        case CustomRoles.Insight:
                            if (player.GetRoleType() is RoleType.Neutral or RoleType.Madmate or RoleType.Impostor or RoleType.Coven) continue;
                            if (player.Is(CustomRoles.Spy)) continue;
                            break;
                        case CustomRoles.Assassin:
                            if (player.GetRoleType() is RoleType.Neutral or RoleType.Madmate or RoleType.Crewmate or RoleType.Coven) continue;
                            break;
                        case CustomRoles.Outsight:
                            if (player.GetRoleType() is RoleType.Neutral or RoleType.Madmate or RoleType.Crewmate or RoleType.Coven) continue;
                            break;
                        case CustomRoles.Amplify:
                            if (player.GetCustomRole() is CustomRoles.Mayor or CustomRoles.Pickpocket or CustomRoles.Vindicator or CustomRoles.Phantom or CustomRoles.Trickster or CustomRoles.Wraith or CustomRoles.Parasite) continue;
                            break;
                        case CustomRoles.Overclocked:
                            if (player.GetRoleType() is RoleType.Crewmate or RoleType.Madmate) continue;
                            //    if (!player.Is(CustomRoles.Sheriff)) continue;
                            //     if (!player.Is(CustomRoles.Parasite)) continue;
                            //          if (player.GetCustomRole() is CustomRoles.Crewmate or CustomRoles.Engineer or CustomRoles.Scientist or CustomRoles.GuardianAngel or CustomRoles.Investigator or CustomRoles.Detective or CustomRoles.Veteran or CustomRoles.Mayor or CustomRoles.Engineer) continue;
                            if (player.GetCustomRole() is CustomRoles.Mare or CustomRoles.LastImpostor or CustomRoles.Juggernaut or CustomRoles.CrewPostor or CustomRoles.Mafia or CustomRoles.Pirate or CustomRoles.Jester or CustomRoles.Executioner or CustomRoles.Hacker or CustomRoles.SchrodingerCat or CustomRoles.Masochist or CustomRoles.Terrorist or CustomRoles.Survivor or CustomRoles.Opportunist or CustomRoles.NeutWitch or CustomRoles.Postman or CustomRoles.Egoist or CustomRoles.Vulture or CustomRoles.Werewolf or CustomRoles.GuardianAngelTOU or CustomRoles.Lawyer) continue;
                            break;
                        case CustomRoles.Sticky:
                            if (player.GetCustomRole() is CustomRoles.Trapper or CustomRoles.Masochist or CustomRoles.Child) continue;
                            break;
                        case CustomRoles.Burst:
                            if (player.GetCustomRole() is CustomRoles.Trapper or CustomRoles.Masochist or CustomRoles.Child) continue;
                            break;
                        case CustomRoles.Tethered:
                            if (player.GetRoleType() is RoleType.Crewmate or RoleType.Madmate or RoleType.Coven or RoleType.Neutral) continue;
                            if (player.GetCustomRole() is CustomRoles.Trickster or CustomRoles.Eradicator or CustomRoles.Wildling or CustomRoles.Swooper or CustomRoles.Grenadier or CustomRoles.Escapist or CustomRoles.Eradicator) continue;
                            break;
                        case CustomRoles.Eternal:
                            if (player.GetRoleType() is RoleType.Coven or RoleType.Neutral) continue;
                            if (player.GetCustomRole() is CustomRoles.Child) continue;
                            break;
                    }
                    ...
                    /*   if (role.IsKillerModifier())
                       {
                           if (!player.GetCustomRole().CanGetKillerModifier()) continue;
                       } */
                }
                allPlayers.Add(player);
            }
