...
namespace TownOfHost
{
    ...
    class BeginCrewmatePatch
    {
        public static void Prefix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> teamToDisplay)
        {
            ...
            if (PlayerControl.LocalPlayer.Is(RoleType.Madmate) && PlayerControl.LocalPlayer.Is(CustomRoles.Undercover))
            {
                var soloTeam = new Il2CppSystem.Collections.Generic.List<PlayerControl>();
                soloTeam.Add(PlayerControl.LocalPlayer);
                teamToDisplay = soloTeam;
        ...
        public static void Postfix(IntroCutscene __instance, ref Il2CppSystem.Collections.Generic.List<PlayerControl> teamToDisplay)
        {
            ...
            switch (roleType)
            {
                ...
                case RoleType.Madmate:
                    ...
                    StartFadeIntro(__instance, Palette.ImpostorRed, Palette.ImpostorRed);
            ...
            try
            {
                switch (modifier)
                {
                    ...
                    case CustomRoles.Chainlink:
                        ...
                        {
                            if (chained.PlayerId == PlayerControl.LocalPlayer.PlayerId) continue;
                            name = chained.GetRealName(true);
                        }
                        ModifierText.text = $"<size=3>Modifier: You are linked with {namee}.</size>\n<size=3>You and {namee} share a life.";
                        ModifierText.color = Utils.GetRoleColor(modifier);
                        ModifierText.transform.position =
                            __instance.transform.position - new Vector3(0f, 1.6f, 0f);
                        ModifierText.gameObject.SetActive(true);
