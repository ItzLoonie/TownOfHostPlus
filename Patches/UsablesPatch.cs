...
namespace TownOfHost
{
    ...
    class CanUseVentPatch
    {
            ...
            ref float __result)
        {
            ...
            if (pc.IsDead) return false; //死んでる人は強制的にfalseに。
            else if (pc.Object.Is(CustomRoles.Sheriff) || pc.Object.Is(CustomRoles.Deputy) || pc.Object.Data.IsImpostor() && GameOptionsManager.Instance.CurrentGameOptions.GameMode == GameModes.HideNSeek || pc.Object.Is(CustomRoles.AgiTater) || pc.Object.Is(CustomRoles.Consigliere) || pc.Object.Is(CustomRoles.PlagueBearer) || pc.Object.Is(CustomRoles.Amnesiac) || pc.Object.Is(CustomRoles.Escort) || pc.Object.Is(CustomRoles.Crusader) || pc.Object.Is(CustomRoles.Janitor) || pc.Object.Is(CustomRoles.Investigator) || (pc.Object.Is(CustomRoles.Arsonist) && !pc.Object.IsDouseDone() && !Options.TOuRArso.GetBool()))
                return false;
            ...
            else if (pc.Object.Is(CustomRoles.Mimicker))
                canUse = couldUse = Options.MimickerCanVent.GetBool();
            ...
            else if (pc.Object.Is(CustomRoles.Trickster))
                canUse = couldUse = false;
            else if (pc.Object.Is(CustomRoles.Tethered))
                canUse = couldUse = false;
            else if (pc.Object.Is(CustomRoles.Saboteur))
                canUse = couldUse = false;
            else if (pc.Object.Is(CustomRoles.Glitch))
                canUse = couldUse = false;
            else if (pc.Object.Is(CustomRoles.Predator))
                canUse = couldUse = false;
            else if (pc.Object.Is(CustomRoles.Wraith))
                canUse = couldUse = true;
            else if (pc.Object.Is(CustomRoles.Traitor))
                canUse = couldUse = true;
            else if (pc.Object.Is(CustomRoles.Juggernaut))
                canUse = couldUse = Options.JuggerCanVent.GetBool();
            else if (pc.Object.Is(CustomRoles.NeutSerialKiller))
                canUse = couldUse = Options.SerialKillerCanVent.GetBool();
            else if (pc.Object.Is(CustomRoles.Vindicator))
                canUse = couldUse = Options.VindicatorCanVent.GetBool();
            else if (pc.Object.Is(CustomRoles.Parasite))
                canUse = couldUse = Options.ParasiteCanVent.GetBool();
            else if (pc.Object.Is(CustomRoles.Marksman))
                canUse = couldUse = Options.MarksmanCanVent.GetBool();
            else if (pc.Object.Is(CustomRoles.Eradicator))
                canUse = couldUse = Options.EradicatorCanVent.GetBool();
                ...
                canUse = couldUse = true;
            else if (pc.Object.Is(CustomRoles.PoisonMaster))
                canUse = couldUse = true;
