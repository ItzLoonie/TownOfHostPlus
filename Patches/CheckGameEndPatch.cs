    ...
    class CheckGameEndPatch
    {
        public static bool Prefix(LogicGameFlowNormal __instance)
        {
            ...
            if (Main.currentWinner == CustomWinner.Default)
            {
                ...
                else
                {
                    ...
                    if (CheckAndEndGameForMimickerWin(instance, statistics)) return false;
                    if (CheckAndEndGameForWraithWin(instance, statistics)) return false;
                    if (CheckAndEndGameForGlitch(instance, statistics)) return false;
                    if (CheckAndEndGameForSerialKillerWin(instance, statistics)) return false;
                    if (CheckAndEndGameForVindicator(instance, statistics)) return false;
                    if (CheckAndEndGameForPoisoner(instance, statistics)) return false;
                    if (CheckAndEndGameForTraitor(instance, statistics)) return false;
                    ...
                    if (CheckAndEndGameForPredatorWin(instance, statistics)) return false;
        ...
        private static bool CheckAndEndGameForImpostorWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamImpostorsAlive >= statistics.TotalAlive - statistics.TeamImpostorsAlive &&
                statistics.TeamJackalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamAgiAlive <= 0
        ...
        private static bool CheckAndEndGameForJackalWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamJackalAlive >= statistics.TotalAlive - statistics.TeamJackalAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
        ...
        private static bool CheckAndEndGameForMimickerWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamMimickerAlive >= statistics.TotalAlive - statistics.TeamMimickerAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
                if (Options.IsStandardHAS && statistics.TotalAlive - statistics.TeamMimickerAlive != 0) return false;
                __instance.enabled = false;
                var endReason = TempData.LastDeathReason switch
                {
                    DeathReason.Exile => GameOverReason.ImpostorByVote,
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.Mimicker);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.MimickerWin();
        ...
        private static bool CheckAndEndGameForWraithWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamWraithAlive >= statistics.TotalAlive - statistics.TeamWraithAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.Wraith);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.WraithWin();
        ...
        {
            if (Main.PreysKilled == Options.PreysNeeded.GetFloat())
            {
                //Vulture wins.
                var people = statistics.TotalAlive;
                __instance.enabled = false;
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.Predator);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.PredatorWin();
        ...
        private static bool CheckAndEndGameForPestiWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamPestiAlive >= statistics.TotalAlive - statistics.TeamPestiAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamMarksAlive <= 0
        ...
        private static bool CheckAndEndGameForArsonistWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (1 >= statistics.TotalAlive - 1 &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 1 && Options.TOuRArso.GetBool())
            {
        ...
        {
            if (statistics.TeamImpostorsAlive == 0 && statistics.TeamEternalAlive == 0 && statistics.TeamTraitorAlive == 0 && statistics.TeamSerialKillerAlive == 0 && statistics.TeamPoisonerAlive == 0 && statistics.TeamVindicatorAlive == 0 && statistics.TeamNewGlitchAlive == 0 && statistics.TeamKnightAlive == 0 && statistics.TeamWraithAlive == 0 && statistics.TeamMimickerAlive == 0 && statistics.TeamJackalAlive == 0 && statistics.TeamJuggernautAlive == 0 && statistics.TeamCovenAlive == 0 && statistics.TeamPestiAlive == 0 && statistics.TeamGlitchAlive == 0 && statistics.TeamWolfAlive == 0 && statistics.TeamArsoAlive == 0 && statistics.TeamMarksAlive == 0 && statistics.TeamAgiAlive == 0)
            {
                __instance.enabled = false;
        ...
        private static bool CheckAndEndGameForJuggyWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamJuggernautAlive >= statistics.TotalAlive - statistics.TeamJuggernautAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamMarksAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0 && statistics.TeamAgiAlive <= 0)
            {
        ...
        private static bool CheckAndEndGameForCovenWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamCovenAlive >= statistics.TotalAlive - statistics.TeamCovenAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMarksAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0 && statistics.TeamAgiAlive <= 0)
            {
        ...
        {
            if (statistics.TeamSerialKillerAlive >= statistics.TotalAlive - statistics.TeamSerialKillerAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamMarksAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0 && statistics.TeamAgiAlive <= 0)
            {
                if (Options.IsStandardHAS && statistics.TotalAlive - statistics.TeamSerialKillerAlive != 0) return false;
                __instance.enabled = false;
                var endReason = TempData.LastDeathReason switch
                {
                    DeathReason.Exile => GameOverReason.ImpostorByVote,
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.SerialKiller);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.SerialKillerWin();
        ...
        private static bool CheckAndEndGameForWolfWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamWolfAlive >= statistics.TotalAlive - statistics.TeamWolfAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0
        ...
        private static bool CheckAndEndGameForGlitch(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamNewGlitchAlive >= statistics.TotalAlive - statistics.TeamNewGlitchAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamNeutralsAlive <= 0 && statistics.TeamCrewmatesAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMarksAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamArsoAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamAgiAlive <= 0)
            {
                if (Options.IsStandardHAS && statistics.TotalAlive - statistics.TeamNewGlitchAlive != 0) return false;
                __instance.enabled = false;
                var endReason = TempData.LastDeathReason switch
                {
                    DeathReason.Exile => GameOverReason.ImpostorByVote,
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.Glitch);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.NewGlitchWin();
        ...
        private static bool CheckAndEndGameForKnighthWin(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamKnightAlive >= statistics.TotalAlive - statistics.TeamKnightAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMarksAlive <= 0
        ...
        private static bool CheckAndEndGameForArsonist(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamArsoAlive >= statistics.TotalAlive - statistics.TeamArsoAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamMarksAlive <= 0
        ...
        private static bool CheckAndEndGameForMarksman(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamMarksAlive >= statistics.TotalAlive - statistics.TeamMarksAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamAgiAlive <= 0
        ...
        private static bool CheckAndEndGameForPoisoner(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamPoisonerAlive >= statistics.TotalAlive - statistics.TeamPoisonerAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.Poisoner);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.PoisWin();
        ...
        private static bool CheckAndEndGameForTraitor(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamTraitorAlive >= statistics.TotalAlive - statistics.TeamTraitorAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamPredatorAlive <= 0 && statistics.TeamNeutralsAlive <= 0 && statistics.TeamCrewmatesAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamVindicatorAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
                if (Options.IsStandardHAS && statistics.TotalAlive - statistics.TeamTraitorAlive != 0) return false;
                __instance.enabled = false;
                var endReason = TempData.LastDeathReason switch
                {
                    DeathReason.Exile => GameOverReason.ImpostorByVote,
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.Traitor);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.TraitorWin();
        ...
        private static bool CheckAndEndGameForVindicator(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamVindicatorAlive >= statistics.TotalAlive - statistics.TeamVindicatorAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamSerialKillerAlive <= 0 && statistics.TeamMarksAlive <= 0 && statistics.TeamPoisonerAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamJackalAlive <= 0 && statistics.TeamAgiAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
                if (Options.IsStandardHAS && statistics.TotalAlive - statistics.TeamVindicatorAlive != 0) return false;
                __instance.enabled = false;
                var endReason = TempData.LastDeathReason switch
                {
                    DeathReason.Exile => GameOverReason.ImpostorByVote,
                ...
                MessageWriter writer = AmongUsClient.Instance.StartRpcImmediately(PlayerControl.LocalPlayer.NetId, (byte)CustomRPC.EndGame, Hazel.SendOption.Reliable, -1);
                writer.Write((byte)CustomWinner.Vindicator);
                AmongUsClient.Instance.FinishRpcImmediately(writer);
                RPC.VindicatorWin();
        ...
        private static bool CheckAndEndGameForAgitater(ShipStatus __instance, PlayerStatistics statistics)
        {
            if (statistics.TeamAgiAlive >= statistics.TotalAlive - statistics.TeamAgiAlive &&
                statistics.TeamImpostorsAlive <= 0 && statistics.TeamEternalAlive <= 0 && statistics.TeamTraitorAlive <= 0 && statistics.TeamJuggernautAlive <= 0 && statistics.TeamPestiAlive <= 0 && statistics.TeamJackalAlive <= 0
                && statistics.TeamWolfAlive <= 0 && statistics.TeamCovenAlive <= 0 && statistics.TeamKnightAlive <= 0 && statistics.TeamGlitchAlive <= 0 && statistics.TeamWraithAlive <= 0 && statistics.TeamMimickerAlive <= 0 && statistics.TeamNewGlitchAlive <= 0 && statistics.TeamArsoAlive <= 0)
            {
        ...
        private static void ResetRoleAndEndGame(GameOverReason reason, bool showAd)
        {
            ...
            foreach (var pc in PlayerControl.AllPlayerControls)
            {
                ...
                if (pc.Is(CustomRoles.Sheriff) || pc.Is(CustomRoles.Deputy) || pc.Is(CustomRoles.Investigator) || pc.Is(CustomRoles.Janitor) || (Main.currentWinner != CustomWinner.Poisoner && pc.Is(CustomRoles.PoisonMaster)) || (Main.currentWinner != CustomWinner.SerialKiller && pc.Is(CustomRoles.NeutSerialKiller)) || (Main.currentWinner != CustomWinner.Traitor && pc.Is(CustomRoles.Traitor)) || (Main.currentWinner != CustomWinner.Vindicator && pc.Is(CustomRoles.Vindicator)) || (Main.currentWinner != CustomWinner.Poisoner && pc.Is(CustomRoles.PoisonMaster)) || pc.Is(CustomRoles.Escort) || pc.Is(CustomRoles.Crusader) ||
                    (!(Main.currentWinner == CustomWinner.Arsonist) && pc.Is(CustomRoles.Arsonist)) || (Main.currentWinner == CustomWinner.Lovers && !Main.LoversPlayers.Contains(pc)) || (pc.Is(CustomRoles.Hitman) && pc.Data.IsDead) || (Main.currentWinner != CustomWinner.Masochist && pc.Is(CustomRoles.Masochist)) || (Main.currentWinner != CustomWinner.Predator && pc.Is(CustomRoles.Predator)) || (Main.currentWinner != CustomWinner.Glitch && pc.Is(CustomRoles.Glitch)) || (Main.currentWinner != CustomWinner.Vulture && pc.Is(CustomRoles.Vulture)) || (Main.currentWinner != CustomWinner.Painter && pc.Is(CustomRoles.Painter)) || (Main.currentWinner != CustomWinner.Marksman && pc.Is(CustomRoles.Marksman)) || (Main.currentWinner != CustomWinner.Pirate && pc.Is(CustomRoles.Pirate)) ||
                    (Main.currentWinner != CustomWinner.Jackal && pc.Is(CustomRoles.Jackal)) || (Main.currentWinner != CustomWinner.Swapper && pc.Is(CustomRoles.Swapper)) || (Main.currentWinner != CustomWinner.Mimicker && pc.Is(CustomRoles.Mimicker)) || (Main.currentWinner != CustomWinner.Wraith && pc.Is(CustomRoles.Wraith)) || (Main.currentWinner != CustomWinner.BloodKnight && pc.Is(CustomRoles.BloodKnight)) || (Main.currentWinner != CustomWinner.Pestilence && pc.Is(CustomRoles.Pestilence)) || (Main.currentWinner != CustomWinner.Coven && pc.GetRoleType() == RoleType.Coven) ||
                    LoseImpostorRole || (Main.currentWinner != CustomWinner.Werewolf && pc.Is(CustomRoles.Werewolf)) || (Main.currentWinner != CustomWinner.Vindicator && pc.Is(CustomRoles.Vindicator)) || (Main.currentWinner != CustomWinner.TheGlitch && pc.Is(CustomRoles.TheGlitch)))
                {
        ...
        public class PlayerStatistics
        {
            ...
            public int TeamEternalAlive { get; set; }
            public int TeamEgoistAlive { get; set; }
            public int TeamNeutralsAlive { get; set; }
            public int TotalAlive { get; set; }
            public int TeamJackalAlive { get; set; }
            public int TeamNewGlitchAlive { get; set; }
            public int TeamWraithAlive { get; set; }
            public int TeamMimickerAlive { get; set; }
            public int TeamPestiAlive { get; set; }
            public int TeamJuggernautAlive { get; set; }
            public int TeamPoisonerAlive { get; set; }
            public int TeamTraitorAlive { get; set; }
            public int TeamPredatorAlive { get; set; }
            public int TeamSerialKillerAlive { get; set; }
            public int TeamVindicatorAlive { get; set; }
            ...
            private void GetPlayerCounts()
            {
                ...
                for (int i = 0; i < GameData.Instance.PlayerCount; i++)
                {
                    ...
                    if (!playerInfo.Disconnected)
                    {
                        if (!playerInfo.IsDead)
                        {
                            ...
                            /*    if (playerInfo.Role.TeamType == RoleTeamTypes.Impostor && playerInfo.Role.TeamType == RoleTeamTypes.Crewmate &&
                                ...
                                playerInfo.GetCustomRole() != CustomRoles.Jackal || playerInfo.GetCustomRole() != CustomRoles.Pestilence || playerInfo.GetCustomRole() != CustomRoles.Mimicker || playerInfo.GetCustomRole() != CustomRoles.Wraith ||
                                ...
                                || playerInfo.GetCustomRole() != CustomRoles.AgiTater || playerInfo.GetCustomRole() != CustomRoles.PoisonMaster || playerInfo.GetCustomRole() != CustomRoles.NeutSerialKiller || playerInfo.GetCustomRole() != CustomRoles.Traitor || playerInfo.GetCustomRole() != CustomRoles.Vindicator || playerInfo.GetCustomRole() != CustomRoles.PoisonMaster))
                                {
                                    numImpostorsAlive++;
                                } */
                            if (playerInfo.GetCustomRole().IsImpostor())
                            {
                                numImpostorsAlive++;
                            }
                            ...
                            else if (playerInfo.GetCustomRole().IsCrewmate())
                            {
                                numCrewAlive++;
                            }
                            else if (playerInfo.GetCustomRole().IsNonNk())
                            {
                                numNeutralsAlive++;
                            }
                            ...
                            else if (playerInfo.GetCustomRole() == CustomRoles.NeutSerialKiller) serialkillers++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Vindicator) vindicators++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.PoisonMaster) poisonAlive++;
                            ...
                            else if (playerInfo.GetCustomRole() == CustomRoles.Wraith) wraiths++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Mimicker) mimicker++;
                            ...
                            else if (playerInfo.GetCustomRole() == CustomRoles.Traitor) traitors++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Predator) predators++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Egoist) egoists++;
                            else if (playerInfo.GetCustomRole() == CustomRoles.Glitch) glitches++;

                            if (playerInfo.GetCustomSubRole() == CustomRoles.LoversRecode) lovers++;
                            else if (playerInfo.GetCustomSubRole() == CustomRoles.Eternal) eternal++;
                        }
                    }
                }
                ...
                TeamCrewmatesAlive = numCrewAlive;
                TeamEternalAlive = eternal;
                TeamEgoistAlive = egoists;
                TeamNeutralsAlive = numNeutralsAlive;
                ...
                TeamSerialKillerAlive = serialkillers;
                TeamVindicatorAlive = vindicators;
                TeamPoisonerAlive = poisonAlive;
                ...
                TeamWraithAlive = wraiths;
                TeamNewGlitchAlive = glitches;
                TeamMimickerAlive = mimicker;
                TeamMarksAlive = marksman;
                TeamTraitorAlive = traitors;
                TeamPredatorAlive = predators;
