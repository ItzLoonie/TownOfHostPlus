...
namespace TownOfHost
{
    public static class Sheriff
    {
        ...
        public static CustomOption SheriffHasDeputy;
        public static CustomOption DeputyCanKill;

        public static Dictionary<byte, float> ShotLimit = new();
        public static Dictionary<byte, float> CurrentKillCooldown = new();
        public static void SetupCustomOption()
        {
            Options.SetupSingleRoleOptions(Id, CustomRoles.Sheriff, 1, AmongUsExtensions.OptionType.Crewmate);
            ...
            ShotLimitOpt = CustomOption.Create(Id + 28, Color.white, "SheriffShotLimit", AmongUsExtensions.OptionType.Crewmate, 15, -1, 15, 1, Options.CustomRoleSpawnChances[CustomRoles.Sheriff]);
            SheriffHasDeputy = CustomOption.Create(Id + 29, Color.white, "SheriffHasDeputy", AmongUsExtensions.OptionType.Crewmate, false, Options.CustomRoleSpawnChances[CustomRoles.Sheriff]);
            DeputyCanKill = CustomOption.Create(Id + 30, Color.white, "DeputyCanKill", AmongUsExtensions.OptionType.Crewmate, false, SheriffHasDeputy);
        }
        ...
        public static string GetShotLimit(byte playerId)
        {
            ...
            else if (ShotLimitOpt.GetInt() == -1) return "";
